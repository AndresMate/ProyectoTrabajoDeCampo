...
public class TournamentController {
    ...
    public ResponseEntity<PageResponseDTO<TournamentResponseDTO>> searchPublic(
    ...
    public ResponseEntity<TournamentResponseDTO> createTournament(
            @Validated(OnCreate.class) @RequestBody TournamentDTO dto
    ) {
    ...
    public ResponseEntity<TournamentResponseDTO> updateTournament(
            ...
            @Validated(OnUpdate.class) @RequestBody TournamentDTO dto
    ) {
    ...
    @Operation(summary = "Completar un torneo", description = "Cambia el estado de IN_PROGRESS a FINISHED")
    @SecurityRequirement(name = "bearerAuth")
    ...
    @Operation(summary = "Cancelar un torneo", description = "Cambia el estado a CANCELLED")
    @SecurityRequirement(name = "bearerAuth")
    ...
    @Operation(summary = "Eliminar un torneo", description = "Solo si está en PLANNING y sin partidos")
    @SecurityRequirement(name = "bearerAuth")
    @DeleteMapping("/{id}")
    ...
    @Operation(summary = "Obtener estadísticas de torneos")
    @SecurityRequirement(name = "bearerAuth")
    @GetMapping("/stats")
